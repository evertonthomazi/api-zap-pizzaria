...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->foreignId('product_id_tertiary')->nullable()->constrained('products')->onDelete('cascade');
            ...
            $table->text('observation_tertiary')->nullable(); // Observação do cliente para o terceiro sabor, se houver
            $table->timestamps();
        });
    }
